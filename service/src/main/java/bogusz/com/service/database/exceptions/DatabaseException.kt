...
sealed class FallDetectorException(override val message: String, val rationale: String = message) : Exception() {
    data class NoSuchRecordException(private val id: Long = 1L) :
    ...
    data class RecordNotUpdatedException(private val id: Long = 1L) : FallDetectorException("Record with id $id was not updated","Record was not updated.")
}